    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <TouchableOpacity onPress={handleMyCar}>
                    <Ionicons name="arrow-back-outline" size={35} color="#000000" />
                </TouchableOpacity>
                <View style={styles.view}>
                    <Text style={styles.texthader}>ADD CAR</Text>
                </View>
            </View>
            ...
            >
                <View style={styles.bottom}>
                    ...
                    /> 
                    <TextInput 
                        placeholder='Transmission(Automatic or Manual)'
                        style={styles.input}
                        textAlign='center'
                        value={transmission}
                    ...
                    /> 
                    <TextInput 
                        placeholder='Fuel(Electricity or Gasoline)'
                        textAlign='center'
                        style={styles.input}
                        value={fuel}
